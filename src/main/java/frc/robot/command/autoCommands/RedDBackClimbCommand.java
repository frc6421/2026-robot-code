...
public class RedDBackClimbCommand extends SequentialCommandGroup {
  /** Creates a new RedDBackClimbCommand. */
  ...
  public RedDBackClimbCommand(IntakeSubsystem intake, ClimbSubsystem climb, CommandSwerveDrivetrain drive,
  ShooterSubsystem shooter, TransitionSubsystem transition) {
    ...
    addCommands(
      ...
      driveSubsystem.profiledAutonAlignCommand(() -> Constants.TrajectoryConstants.RD_FAR_EDGE), 
      driveSubsystem.profiledAutonAlignCommand(() -> Constants.TrajectoryConstants.NEUTRAL_RD_EDGE),
      driveSubsystem.profiledAutonAlignCommand(() -> Constants.TrajectoryConstants.RED_BUMP_D_R), 
      zoneCommand,
