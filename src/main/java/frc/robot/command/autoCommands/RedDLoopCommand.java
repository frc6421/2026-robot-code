...
public class RedDLoopCommand extends SequentialCommandGroup {
  /** Creates a new RedDLoopCommand. */
 private CommandSwerveDrivetrain driveSubsystem;
  ...
  public RedDLoopCommand(IntakeSubsystem intake, ClimbSubsystem climb, CommandSwerveDrivetrain drive,
