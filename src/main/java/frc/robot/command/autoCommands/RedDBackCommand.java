...
public class RedDBackCommand extends SequentialCommandGroup {
  /** Creates a new RedDBackCommand. */
  ...
  public RedDBackCommand(IntakeSubsystem intake, ClimbSubsystem climb, CommandSwerveDrivetrain drive,
