...
public class RedDLoopClimbCommand extends SequentialCommandGroup {
  /** Creates a new RedDLoopClimbCommand. */
  ...
  public RedDLoopClimbCommand(IntakeSubsystem intake, ClimbSubsystem climb, CommandSwerveDrivetrain drive,
